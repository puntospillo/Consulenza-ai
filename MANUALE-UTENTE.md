...
Per ogni fornitore, elenco degli interventi svolti dai suoi tecnici, con possibilità di inserire l'importo fatturato e passare la voce a "fatturato". Mostra N°, N° Ticket, costo stimato, ricavi, margine, margine%. È possibile cercare per N° intervento o N° ticket. Gli interventi svolti da **tecnici interni** non compaiono mai qui (né nell'avviso "in attesa di fattura del fornitore" della pagina Interventi): questa sezione riguarda solo i tecnici di fornitori esterni. Filtri aggiuntivi per cliente, contratto e tecnico (oltre a fornitore/periodo/stato fattura già presenti). **Costo e margine**: prima di registrare la fattura del fornitore, il costo è stimato sul costo orario standard del tecnico; una volta inserito l'importo fatturato e premuto "Segna come fatturati", costo e margine (qui e in tutto il resto dell'app) vengono ricalcolati sull'importo realmente fatturato (importo ÷ ore), non più sulla stima.
